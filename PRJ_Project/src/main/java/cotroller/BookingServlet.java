...
public class BookingServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        //Display the showtime selection page
        if (action == null || action.equals("select_showtime")) {
            // Giả định đã truyền hoặc lấy được movieId
        ...
        } //Step2: Khi người dùng bấm chọn một Suất Chiếu cụ thể để đi tiếp
            ...
            int movieAgeRestriction = 18; //lấy từ MovieDAO dựa theo movieId
            ...
            // Nếu mọi thứ hợp lệ -> Chuyển sang trang chọn ghế
